...
public class HellowGithub {
	public static void main(String[] args) {
		System.out.println(" I know how to creat a separate remote repository in Github");
		System.out.println("and can push my project GithubDemo without help of anyone.");
	}
